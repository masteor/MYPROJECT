...
namespace DBPSA.Shared.Tests.Core.Db.Services
{
    ...
    /// </summary>
        [TestFixture]
    public class STAFF_RepositoryTests : Init
    {
        /// <summary>
        /// настройка 
        /// </summary>
        private static STAFF_Repository Setup()
        {
            return new STAFF_Repository(DB_FACTORY);
        }

        [Test]
        public void TEST_Create()
        {
            /*var model = Create(new STAFF
            {
        ...
        {
            /*var entity_to_create = new STAFF
            {
                NET_NAME = "TEST_CRU",
            ...
            var entity_to_create = new STAFF
            {
                ...
                ROLE = nameof(TEST_CRU),
                ID_NEW = null,
                ID_REQUEST_1 = 0,
                ID_REQUEST_2 = null
            };
            
            /*var entity_to_update = new STAFF
            {
                ID = 0, // не обновляем
        ...
        private static STAFF Upd(STAFF u)
        {
            /*var model = new STAFF
            {
                ID = u.ID,
        ...
        private static STAFF Create(STAFF model)
        {
            // предпроверка
        ...
        private static STAFF Read(int? id)
        {
            // подготовка
            var repository = Setup();
        ...
        private void Delete(STAFF model)
        {
            // подготовка
            var repository = Setup();
        ...
        private static void Update(STAFF model)
        {
            // подготовка
            var repository = Setup();
            Assert.NotNull(model);
