...
namespace DBPSA.Shared.Tests.Core.Db.Services
{
    ...
    /// </summary>
    [TestFixture]
    public class JOB_RepositoryTests : Init
    {
        /// <summary>
        /// настройка 
        /// </summary>
        private static JOB_Repository Setup()
        {
            return new JOB_Repository(DB_FACTORY);
        }

        [Test]
        public void TEST_Create()
        {
            /*var model = Create(new JOB
            {
        ...
        private static JOB Create(JOB model)
        {
            // предпроверка
        ...
        private static JOB Read(int? id)
        {
            // подготовка
            var repository = Setup();
        ...
        private static void Update(JOB model)
        {
            // подготовка
            var repository = Setup();
            Assert.NotNull(model);
