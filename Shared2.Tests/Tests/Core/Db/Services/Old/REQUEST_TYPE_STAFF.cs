...
namespace DBPSA.Shared.Tests.Core.Db.Services
{
    ...
    /// </summary>
    [TestFixture]
    public class REQUEST_TYPE_STAFF_RepositoryTests : Init
    {
        /// <summary>
        /// настройка 
        /// </summary>
        private static REQUEST_TYPE_STAFF_Repository Setup()
        {
            return new REQUEST_TYPE_STAFF_Repository(DB_FACTORY);
        }

        [Test]
        public void TEST_Create()
        {
            /*var model = Create(new REQUEST_TYPE_STAFF
            {
        ...
        {
            /*var model = new REQUEST_TYPE_STAFF
            {
                ID = 0,
        ...
        {
            /*var entity_to_create = new REQUEST_TYPE_STAFF
            {
                NET_NAME = "TEST_CRU",
            ...
            /*var entity_to_update = new REQUEST_TYPE_STAFF
            {
                ID = 0, // не обновляем
            ...
            e.ID_STAFF = entity_to_update.ID_STAFF;
        ...
        private static REQUEST_TYPE_STAFF Upd(REQUEST_TYPE_STAFF u)
        {
            /*var model = new REQUEST_TYPE_STAFF
            {
                ID = u.ID,
        ...
        private static REQUEST_TYPE_STAFF Create(REQUEST_TYPE_STAFF model)
        {
            // предпроверка
        ...
        private static REQUEST_TYPE_STAFF Read(int? id)
        {
            // подготовка
            var repository = Setup();

            REQUEST_TYPE_STAFF e_readed;
            // действие
            if (id != null) 
            {
        ...
        private void Delete(REQUEST_TYPE_STAFF model)
        {
            // подготовка
            var repository = Setup();
        ...
        private static void Update(REQUEST_TYPE_STAFF model)
        {
            // подготовка
            var repository = Setup();
            Assert.NotNull(model);
