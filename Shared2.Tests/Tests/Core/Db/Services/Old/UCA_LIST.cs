...
namespace DBPSA.Shared.Tests.Core.Db.Services
{
    ...
    /// </summary>
        [TestFixture]
    public class UCA_LIST_RepositoryTests : Init
    {
        /// <summary>
        /// настройка 
        /// </summary>
        private static UCA_LIST_Repository Setup()
        {
            return new UCA_LIST_Repository(DB_FACTORY);
        }

        [Test]
        public void TEST_Create()
        {
            /*var model = Create(new UCA_LIST
            {
        ...
        {
            /*var entity_to_create = new UCA_LIST
            {
                NET_NAME = "TEST_CRU",
            ...
            /*var entity_to_update = new UCA_LIST
            {
                ID = 0, // не обновляем
        ...
        private static UCA_LIST Upd(UCA_LIST u)
        {
            /*var model = new UCA_LIST
            {
                ID = u.ID,
        ...
        private static UCA_LIST Create(UCA_LIST model)
        {
            // предпроверка
        ...
        private static UCA_LIST Read(int? id)
        {
            // подготовка
            var repository = Setup();
        ...
        private void Delete(UCA_LIST model)
        {
            // подготовка
            var repository = Setup();
        ...
        private static void Update(UCA_LIST model)
        {
            // подготовка
            var repository = Setup();
            Assert.NotNull(model);
