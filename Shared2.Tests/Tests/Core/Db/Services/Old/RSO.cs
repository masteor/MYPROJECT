...
namespace DBPSA.Shared.Tests.Core.Db.Services
{
    ...
    /// </summary>
    [TestFixture]
    public class RSO_RepositoryTests : Init
    {
        /// <summary>
        /// настройка 
        /// </summary>
        private static RSO_Repository Setup()
        {
            return new RSO_Repository(DB_FACTORY);
        }

        [Test]
        public void TEST_Create()
        {
            /*var model = Create(new RSO
            {
        ...
        public void TEST_CRU() 
        {
            ...
            {
                ID_USER = 0,
                COMMENT = nameof(TEST_CRU)
            };
            
            /*var entity_to_update = new RSO
            {
                ID = 0, // не обновляем
            ...
            e.COMMENT = entity_to_update.COMMENT;
        ...
        private static RSO Create(RSO model)
        {
            // предпроверка
        ...
        private static RSO Read(int? id)
        {
            // подготовка
            var repository = Setup();
        ...
        private static void Update(RSO model)
        {
            // подготовка
            var repository = Setup();
            Assert.NotNull(model);
