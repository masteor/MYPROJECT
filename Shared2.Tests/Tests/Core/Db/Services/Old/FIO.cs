...
namespace DBPSA.Shared.Tests.Core.Db.Services
{
    ...
    /// </summary>
    [TestFixture]
    public class FIO_RepositoryTests : Init
    {
        /// <summary>
        /// настройка 
        /// </summary>
        private static FIO_Repository Setup()
        {
            return new FIO_Repository(DB_FACTORY);
        }

        [Test]
        public void TEST_Create()
        {
            /*var model = Create(new FIO
            {
            ...
            {
                ID_USER = 0,
                FAMILY_NAME = nameof(TEST_Create),
                NAME = nameof(TEST_Create),
                PATRONYMIC = nameof(TEST_Create),
                ID_REQUEST_1 = 0,
                ID_REQUEST_2 = null
            });
        ...
        public void TEST_Delete()
        {
            ...
            var model = new FIO
            {
                ID = 0,
                ID_USER = 0,
                FAMILY_NAME = nameof(TEST_Delete),
                NAME = nameof(TEST_Delete),
                PATRONYMIC = nameof(TEST_Delete),
                ID_REQUEST_1 = 0,
                ID_REQUEST_2 = null
            };
        ...
        public void TEST_CRU() 
        {
            ...
            {
                ID_USER = 0,
                FAMILY_NAME = nameof(TEST_CRU),
                NAME = nameof(TEST_CRU),
                PATRONYMIC = nameof(TEST_CRU),
                ID_REQUEST_1 = 0,
                ID_REQUEST_2 = null
            };
            
            /*var entity_to_update = new FIO
            {
                ID = 0, // не обновляем
            ...
            var entity_to_update = new FIO
            {
                ID = 0,
                ID_USER = 0,
                FAMILY_NAME = "TEST_CRU_UPDATED",
                NAME = "TEST_CRU_UPDATED",
                PATRONYMIC = "TEST_CRU_UPDATED",
                ID_REQUEST_1 = 0,
                ID_REQUEST_2 = null
            };
            ...
            e.ID_USER = entity_to_update.ID_USER;
            e.ID_REQUEST_1 = entity_to_update.ID_REQUEST_1;
            e.ID_REQUEST_2 = entity_to_update.ID_REQUEST_2;
            e.FAMILY_NAME = entity_to_update.FAMILY_NAME;
            e.PATRONYMIC = entity_to_update.PATRONYMIC;
            ...
            /*Read(e.ID).Should().BeEquivalentTo(entity_to_update, opt => opt.Including(o=>o.КороткоеНазвание).Including(o=>o.FNAME).Including(o=>o.Домен)); // проверяются только эти*/
        ...
        private static FIO Create(FIO model)
        {
            // предпроверка
        ...
        private static FIO Read(int? id)
        {
            // подготовка
            var repository = Setup();
        ...
        private static void Update(FIO model)
        {
            // подготовка
            var repository = Setup();
            Assert.NotNull(model);
