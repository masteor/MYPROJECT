...
namespace DBPSA.Shared.Tests.Core.Db.Services
{
    ...
    /// </summary>
    [TestFixture]
    public class ORG_RepositoryTests : Init
    {
        /// <summary>
        /// настройка 
        /// </summary>
        private static ORG_Repository Setup()
        {
            return new ORG_Repository(DB_FACTORY);
        }

        [Test]
        public void TEST_Create()
        {
            /*var model = Create(new ORG
            {
        ...
        public void TEST_CRU() 
        {
            ...
            e.ID_UNIT_TYPE = entity_to_update.ID_UNIT_TYPE;
            e.ID_USER_BOSS = entity_to_update.ID_USER_BOSS;
        ...
        private static ORG Upd(ORG u)
        {
            ...
            var model = new ORG
            {
                ...
                KOD = u.KOD,
                FNAME = u.FNAME,
                ID_USER_BOSS = u.ID_USER_BOSS,
                ID_PARENT = u.ID_PARENT,
                ID_UNIT_TYPE = u.ID_UNIT_TYPE,
                ID_NEW = u.ID_NEW,
        ...
        private static ORG Create(ORG model)
        {
            // предпроверка
        ...
        private static ORG Read(int? id)
        {
            // подготовка
            var repository = Setup();
        ...
        private static void Update(ORG model)
        {
            // подготовка
            var repository = Setup();
            Assert.NotNull(model);
