...
namespace DBPSA.Shared.Tests.Core.Db.Services
{
    ...
    /// </summary>
    [TestFixture]
    public class FORM_PERM_RepositoryTests : Init
    {
        /// <summary>
        /// настройка 
        /// </summary>
        private static FORM_PERM_Repository Setup()
        {
            return new FORM_PERM_Repository(DB_FACTORY);
        }

        [Test]
        public void TEST_Create()
        {
            /*var model = Create(new FORM_PERM
            {
        ...
        {
            /*var entity_to_create = new FORM_PERM
            {
                NET_NAME = "TEST_CRU",
            ...
            /*var entity_to_update = new FORM_PERM
            {
                ID = 0, // не обновляем
        ...
        private static FORM_PERM Upd(FORM_PERM u)
        {
            /*var model = new FORM_PERM
            {
                ID = u.ID,
        ...
        private static FORM_PERM Create(FORM_PERM model)
        {
            // предпроверка
        ...
        private static FORM_PERM Read(int? id)
        {
            // подготовка
            var repository = Setup();
        ...
        private void Delete(FORM_PERM model)
        {
            // подготовка
            var repository = Setup();
        ...
        private static void Update(FORM_PERM model)
        {
            // подготовка
            var repository = Setup();
            Assert.NotNull(model);
