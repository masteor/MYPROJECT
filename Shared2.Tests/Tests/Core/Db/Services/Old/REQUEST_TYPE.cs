...
namespace DBPSA.Shared.Tests.Core.Db.Services
{
    ...
    public class REQUEST_TYPE_RepositoryTests : Init
    {
        ...
        {
            /*var model = Create(new REQUEST_TYPE
            {
            ...
            var model = Create(new REQUEST_TYPE
            {
                ...
                SDESCRIPTION = nameof(TEST_Create),
                ID_PARENT = null,
                MAINTENANCE = null
            });
        ...
        public void TEST_Delete()
        {
            ...
            var model = new REQUEST_TYPE
            {
                ...
                SDESCRIPTION = nameof(TEST_Delete),
                ID_PARENT = null,
                MAINTENANCE = null
            };
        ...
        {
            /*var entity_to_create = new REQUEST_TYPE
            {
                NET_NAME = "TEST_CRU",
            ...
            var entity_to_create = new REQUEST_TYPE
            {
                ...
                SDESCRIPTION = nameof(TEST_CRU),
                ID_PARENT = null,
                MAINTENANCE = null
            };
            
            /*var entity_to_update = new REQUEST_TYPE
            {
                ID = 0, // не обновляем
            ...
            e.MAINTENANCE = entity_to_update.MAINTENANCE;
            e.SDESCRIPTION = entity_to_update.SDESCRIPTION;
        ...
        private static REQUEST_TYPE Upd(REQUEST_TYPE u)
        {
            /*var model = new REQUEST_TYPE
            {
                ID = u.ID,
        ...
        private static REQUEST_TYPE Create(REQUEST_TYPE model)
        {
            // предпроверка
        ...
        private static REQUEST_TYPE Read(int? id)
        {
            // подготовка
            var repository = Setup();

            REQUEST_TYPE e_readed;
            // действие
            if (id != null) 
            {
        ...
        private void Delete(REQUEST_TYPE model)
        {
            // подготовка
            var repository = Setup();
        ...
        private static void Update(REQUEST_TYPE model)
        {
            // подготовка
            var repository = Setup();
            Assert.NotNull(model);
