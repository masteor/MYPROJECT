...
namespace DBPSA.Shared.Tests.Core.Db.Services
{
    ...
    /// </summary>
        [TestFixture]
    public class STAFF_UNIT_RepositoryTests : Init
    {
        /// <summary>
        /// настройка 
        /// </summary>
        private static STAFF_UNIT_Repository Setup()
        {
            return new STAFF_UNIT_Repository(DB_FACTORY);
        }

        [Test]
        public void TEST_Create()
        {
            /*var model = Create(new STAFF_UNIT
            {
        ...
        {
            /*var entity_to_create = new STAFF_UNIT
            {
                NET_NAME = "TEST_CRU",
            ...
            /*var entity_to_update = new STAFF_UNIT
            {
                ID = 0, // не обновляем
        ...
        private static STAFF_UNIT Upd(STAFF_UNIT u)
        {
            /*var model = new STAFF_UNIT
            {
                ID = u.ID,
        ...
        private static STAFF_UNIT Create(STAFF_UNIT model)
        {
            // предпроверка
        ...
        private static STAFF_UNIT Read(int? id)
        {
            // подготовка
            var repository = Setup();
        ...
        private void Delete(STAFF_UNIT model)
        {
            // подготовка
            var repository = Setup();
        ...
        private static void Update(STAFF_UNIT model)
        {
            // подготовка
            var repository = Setup();
            Assert.NotNull(model);
