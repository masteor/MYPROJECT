...
namespace DBPSA.Shared.Tests.Core.Db.Services
{
    ...
    /// </summary>
    [TestFixture]
    public class PROM_AREA_RepositoryTests : Init
    {
        /// <summary>
        /// настройка 
        /// </summary>
        private static PROM_AREA_Repository Setup()
        {
            return new PROM_AREA_Repository(DB_FACTORY);
        }

        [Test]
        public void TEST_Create()
        {
            /*var model = Create(new PROM_AREA
            {
        ...
        {
            /*var entity_to_create = new PROM_AREA
            {
                NET_NAME = "TEST_CRU",
            ...
            /*var entity_to_update = new PROM_AREA
            {
                ID = 0, // не обновляем
        ...
        private static PROM_AREA Upd(PROM_AREA u)
        {
            /*var model = new PROM_AREA
            {
                ID = u.ID,
        ...
        private static PROM_AREA Create(PROM_AREA model)
        {
            // предпроверка
        ...
        private static PROM_AREA Read(int? id)
        {
            // подготовка
            var repository = Setup();
        ...
        private void Delete(PROM_AREA model)
        {
            // подготовка
            var repository = Setup();
        ...
        private static void Update(PROM_AREA model)
        {
            // подготовка
            var repository = Setup();
            Assert.NotNull(model);
