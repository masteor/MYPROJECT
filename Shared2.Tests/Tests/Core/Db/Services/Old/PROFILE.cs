...
namespace DBPSA.Shared.Tests.Core.Db.Services
{
    ...
    /// </summary>
    [TestFixture]
    public class PROFILE_RepositoryTests : Init
    {
        /// <summary>
        /// настройка 
        /// </summary>
        private static PROFILE_Repository Setup()
        {
            return new PROFILE_Repository(DB_FACTORY);
        }

        [Test]
        public void TEST_Create()
        {
            /*var model = Create(new PROFILE
            {
        ...
        {
            /*var entity_to_create = new PROFILE
            {
                NET_NAME = "TEST_CRU",
            ...
            /*var entity_to_update = new PROFILE
            {
                ID = 0, // не обновляем
        ...
        private static PROFILE Upd(PROFILE u)
        {
            /*var model = new PROFILE
            {
                ID = u.ID,
        ...
        private static PROFILE Create(PROFILE model)
        {
            // предпроверка
        ...
        private static PROFILE Read(int? id)
        {
            // подготовка
            var repository = Setup();
        ...
        private void Delete(PROFILE model)
        {
            // подготовка
            var repository = Setup();
        ...
        private static void Update(PROFILE model)
        {
            // подготовка
            var repository = Setup();
            Assert.NotNull(model);
