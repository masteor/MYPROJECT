...
namespace DBPSA.Shared.Tests.Core.Db.Services
{
    ...
    /// </summary>
    [TestFixture]
    public class EXECUTION_RepositoryTests : Init
    {
        /// <summary>
        /// настройка 
        /// </summary>
        public static EXECUTION_Repository Setup()
        {
            return new EXECUTION_Repository(DB_FACTORY);
        }

        [Test]
        public void TEST_Create()
        {
            /*var model = Create(new EXECUTION
            {
            ...
            var model = Create(new EXECUTION
            {
                ...
                DATE_1 = DateTime.Now,
                DATE_2 = null,
                ID_REQUEST_STATE_1 = 0,
                ID_REQUEST_STATE_2 = null
            });
        ...
        {
            /*var entity_to_create = new EXECUTION
            {
                NET_NAME = "TEST_CRU",
            ...
            /*var entity_to_update = new EXECUTION
            {
                ID = 0, // не обновляем
            ...
            e.DATE_2 = entity_to_update.DATE_2;
            e.ID_REQUEST = entity_to_update.ID_REQUEST;
            e.ID_EXECUTOR = entity_to_update.ID_EXECUTOR;
            e.ID_REQUEST_STATE_1 = entity_to_update.ID_REQUEST_STATE_1;
            e.ID_REQUEST_STATE_2 = entity_to_update.ID_REQUEST_STATE_2;
        ...
        private static EXECUTION Upd(EXECUTION u)
        {
            /*var model = new EXECUTION
            {
                ID = u.ID,
            ...
            {
                ID = u.ID,
                ID_REQUEST = u.ID_REQUEST,
                ID_EXECUTOR = u.ID_EXECUTOR,
                DATE_1 = u.DATE_1,
                DATE_2 = u.DATE_2,
                ID_REQUEST_STATE_1 = u.ID_REQUEST_STATE_1,
                ID_REQUEST_STATE_2 = u.ID_REQUEST_STATE_2 
            };
            return model;
        }

        private static EXECUTION Create(EXECUTION model)
        {
            // предпроверка
        ...
        private static EXECUTION Read(int? id)
        {
            // подготовка
            var repository = Setup();
        ...
        private void Delete(EXECUTION model)
        {
            // подготовка
            var repository = Setup();
        ...
        private static void Update(EXECUTION model)
        {
            // подготовка
            var repository = Setup();
            Assert.NotNull(model);
