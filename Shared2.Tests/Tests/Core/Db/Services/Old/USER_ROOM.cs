...
namespace DBPSA.Shared.Tests.Core.Db.Services
{
    ...
    /// </summary>
        [TestFixture]
    public class USER_ROOM_RepositoryTests : Init
    {
        /// <summary>
        /// настройка 
        /// </summary>
        private static USER_ROOM_Repository Setup()
        {
            return new USER_ROOM_Repository(DB_FACTORY);
        }

        [Test]
        public void TEST_Create()
        {
            /*var model = Create(new USER_ROOM
            {
        ...
        {
            /*var entity_to_create = new USER_ROOM
            {
                NET_NAME = "TEST_CRU",
            ...
            /*var entity_to_update = new USER_ROOM
            {
                ID = 0, // не обновляем
            ...
            e.ID_ROOM = entity_to_update.ID_ROOM;
        ...
        private static USER_ROOM Upd(USER_ROOM u)
        {
            /*var model = new USER_ROOM
            {
                ID = u.ID,
        ...
        private static USER_ROOM Create(USER_ROOM model)
        {
            // предпроверка
        ...
        private static USER_ROOM Read(int? id)
        {
            // подготовка
            var repository = Setup();
        ...
        private void Delete(USER_ROOM model)
        {
            // подготовка
            var repository = Setup();
        ...
        private static void Update(USER_ROOM model)
        {
            // подготовка
            var repository = Setup();
            Assert.NotNull(model);
