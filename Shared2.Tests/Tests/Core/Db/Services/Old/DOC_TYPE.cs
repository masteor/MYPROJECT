...
namespace DBPSA.Shared.Tests.Core.Db.Services
{
    ...
    public class DOC_TYPE_RepositoryTests : Init
    {
        ...
        {
            /*var entity_to_create = new DOC_TYPE
            {
                NET_NAME = "TEST_CRU",
            ...
            /*var entity_to_update = new DOC_TYPE
            {
                ID = 0, // не обновляем
        ...
        private static DOC_TYPE Upd(DOC_TYPE u)
        {
            /*var model = new DOC_TYPE
            {
                ID = u.ID,
        ...
        private static DOC_TYPE Create(DOC_TYPE model)
        {
            // предпроверка
        ...
        private static DOC_TYPE Read(int? id)
        {
            // подготовка
            var repository = Setup();
        ...
        private void Delete(DOC_TYPE model)
        {
            // подготовка
            var repository = Setup();
        ...
        private static void Update(DOC_TYPE model)
        {
            // подготовка
            var repository = Setup();
            Assert.NotNull(model);
