...
namespace DBPSA.Shared.Tests.Core.Db.Services
{
    ...
    public class ROOM_RepositoryTests : Init
    {
        ...
        public void TEST_CRU() 
        {
            ...
            var entity_to_create = new ROOM
            {
                PHONE = nameof(TEST_CRU),
                NUM = nameof(TEST_CRU),
                ID_BUILDING = 0
            };
            
            /*var entity_to_update = new ROOM
            {
                ID = 0, // не обновляем
            ...
            e.NUM = entity_to_update.NUM;
            e.PHONE = entity_to_update.PHONE;
            e.ID_BUILDING = entity_to_update.ID_BUILDING;
        ...
        private static ROOM Upd(ROOM u)
        {
            /*var model = new ROOM
            {
                ID = u.ID,
        ...
        private static ROOM Create(ROOM model)
        {
            // предпроверка
        ...
        private static ROOM Read(int? id)
        {
            // подготовка
            var repository = Setup();
        ...
        private void Delete(ROOM model)
        {
            // подготовка
            var repository = Setup();
        ...
        private static void Update(ROOM model)
        {
            // подготовка
            var repository = Setup();
            Assert.NotNull(model);
