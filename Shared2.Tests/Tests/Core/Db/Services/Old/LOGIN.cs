...
namespace DBPSA.Shared.Tests.Core.Db.Services
{
    ...
    /// </summary>
    [TestFixture]
    public class LOGIN_RepositoryTests : Init
    {
        /// <summary>
        /// настройка 
        /// </summary>
        private static LOGIN_Repository Setup()
        {
            return new LOGIN_Repository(DB_FACTORY);
        }

        [Test]
        public void TEST_Create()
        {
            /*var model = Create(new LOGIN
            {
        ...
        {
            /*var entity_to_create = new LOGIN
            {
                NET_NAME = "TEST_CRU",
            ...
            var entity_to_create = new LOGIN
            {
                ...
                ID_USER = 0,
                ID_DOMEN = 0,
                EMAIL = nameof(TEST_CRU),
                ID_REQUEST_0 = null,
                ID_REQUEST_1 = 0,
                ID_REQUEST_2 = null
            };
            
            /*var entity_to_update = new LOGIN
            {
                ID = 0, // не обновляем
            ...
            e.EMAIL = entity_to_update.EMAIL;
            e.ID_USER = e.ID_USER;
            e.ID_DOMEN = e.ID_DOMEN;
            e.ID_REQUEST_0 = entity_to_update.ID_REQUEST_0;
        ...
        private static LOGIN Upd(LOGIN u)
        {
            /*var model = new LOGIN
            {
                ID = u.ID,
        ...
        private static LOGIN Create(LOGIN model)
        {
            // предпроверка
        ...
        private static LOGIN Read(int? id)
        {
            // подготовка
            var repository = Setup();
        ...
        private void Delete(LOGIN model)
        {
            // подготовка
            var repository = Setup();
        ...
        private static void Update(LOGIN model)
        {
            // подготовка
            var repository = Setup();
            Assert.NotNull(model);
