...
{
    [TestFixture]
    public class _EMPLOYEE__Tests : Init
    {
        private const string ИМЯ_ТАБЛИЦЫ = ИмяТаблицы.Employee;
        ...
        private static EMPLOYEE_Repository Setup() => new EMPLOYEE_Repository(DB_FACTORY);
    }
}