...
{
    [TestFixture]
    public class STAFF_UNIT__Tests : Init
    {
        private const string ИМЯ_ТАБЛИЦЫ = ИмяТаблицы.StaffUnit;
        ...
        private static STAFF_UNIT_Repository Setup() => new STAFF_UNIT_Repository(DB_FACTORY);
    }
}