...
{
    [TestFixture]
    public class VIEW_MEMBER_ORG__Tests : Init
    {
        private const string ИМЯ_ТАБЛИЦЫ = ИмяТаблицы.VIEW_MEMBER_ORG;
...
//            Assert.IsNotEmpty(all);
        ...
        private static VIEW_MEMBER_ORG_Repository Setup() => new VIEW_MEMBER_ORG_Repository(DB_FACTORY);
    }
}