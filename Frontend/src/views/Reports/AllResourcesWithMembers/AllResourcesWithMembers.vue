...
<script>
  import { переченьРесурсовККоторымПредоставленДоступСубъектам as title } from '../../../constants/titles'
  import { ПЕРЕЧЕНЬ_РЕСУРСОВ_К_КОТОРЫМ_ПРЕДОСТАВЛЕН_ДОСТУП_СУБЪЕКТАМ as Header } from '../../../store/header-types'
