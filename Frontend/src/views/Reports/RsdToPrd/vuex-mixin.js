...
import { ПОЛУЧИТЬ_РАЗРЕШИТЕЛЬНАЯ_СИСТЕМА_ДОСТУПА_К_РЕСУРСАМ_С_СЕРВЕРА_ИЗ_ПРД } from '@/store/action-types'
...
export const vuexMixin = {
  ...
  methods: {
    ...mapActions([
      ПОЛУЧИТЬ_РАЗРЕШИТЕЛЬНАЯ_СИСТЕМА_ДОСТУПА_К_РЕСУРСАМ_С_СЕРВЕРА_ИЗ_ПРД,
    ]),
  },
}
