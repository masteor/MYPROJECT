...
<script>
  import { ПЕРЕЧЕНЬ_АРМ_В_АС as Header } from '../../../store/header-types'
  import { ПАРАМЕТРЫ_ЗАПРОСА_НА_ДАТУ } from '@/store/param-types'
  import { переченьАрмВАс as title } from '@/constants/titles'
  ...
  export default {
    ...
    methods: {
      получитьДанныеДляТаблицы () {
        this.loading = true
        this.ПОЛУЧИТЬ_ПЕРЕЧЕНЬ_АРМ_В_АС_С_СЕРВЕРА(
